...
import com.example.myapplication.adapter.SoftwareAdapter;
import com.example.myapplication.baen.AppInfo;
...
public class SoftwareManageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_software_manage, container, false);

        listview = (ListView) view.findViewById(R.id.listview2);
        topText = (TextView) view.findViewById(R.id.topText);
        mProgressBar=(View) view.findViewById(R.id.progressBar);
        mProgressBarText =(TextView)view.findViewById(R.id.progressBarText2);
