package com.example.library.SearchView.db;
...
public class HistoryContract {
    ...
    private static String initAuthority() {
        String authority = "com.example.library.SearchView.defaultsearchhistorydatabase";

        try {
            ClassLoader clazzLoader = HistoryContract.class.getClassLoader();
            Class<?> clazz = clazzLoader.loadClass("com.example.myapplication.baen.MsvAuthority");
