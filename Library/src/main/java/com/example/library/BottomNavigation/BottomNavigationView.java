package com.example.library.BottomNavigation;
...
public class BottomNavigationView extends RelativeLayout {
    ...
    private final int NAVIGATION_HEIGHT = (int) getResources().getDimension(com.example.library.R.dimen.bottom_navigation_height);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (coloredBackground) {
            itemActiveColorWithoutColoredBackground = ContextCompat.getColor(context, R.color.black);
            itemInactiveColor = ContextCompat.getColor(context, R.color.black);
            shadowHeight = (int) getResources().getDimension(com.example.library.R.dimen.bottom_navigation_shadow_height);
        } else {
            if (itemActiveColorWithoutColoredBackground == -1)
                itemActiveColorWithoutColoredBackground = ContextCompat.getColor(context, com.example.library.R.color.itemActiveColorWithoutColoredBackground);
            itemInactiveColor = ContextCompat.getColor(context, com.example.library.R.color.withoutColoredBackground);
            shadowHeight = (int) getResources().getDimension(com.example.library.R.dimen.bottom_navigation_shadow_height_without_colored_background);
        }
        if (isTablet) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                setElevation(getResources().getDimension(com.example.library.R.dimen.bottom_navigation_elevation));
            }
        }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int white = ContextCompat.getColor(context, com.example.library.R.color.white);
        ...
        if (isTablet) {
            ...
            shadow.setBackgroundResource(com.example.library.R.drawable.shadow);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                LayoutParams backgroundLayoutParams = new LayoutParams(
        ...
        for (int i = 0; i < bottomNavigationItems.size(); i++) {
            ...
            int textActivePaddingTop = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_active);
            int viewInactivePaddingTop = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_inactive);
            int viewInactivePaddingTopWithoutText = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_inactive_without_text);
            final View view = inflater.inflate(com.example.library.R.layout.bottom_navigation, this, false);
            ImageView icon = (ImageView) view.findViewById(com.example.library.R.id.bottom_navigation_item_icon);
            TextView title = (TextView) view.findViewById(com.example.library.R.id.bottom_navigation_item_title);
    ...
    private void onBottomNavigationItemClick(final int itemIndex) {
        ...
        int viewActivePaddingTop = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_active);
        int viewInactivePaddingTop = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_inactive);
        int viewInactivePaddingTopWithoutText = (int) context.getResources().getDimension(com.example.library.R.dimen.bottom_navigation_padding_top_inactive_without_text);
        int centerX;
        int centerY;
        for (int i = 0; i < viewList.size(); i++) {
            if (i == itemIndex) {
                View view = viewList.get(itemIndex).findViewById(com.example.library.R.id.bottom_navigation_container);
                final TextView title = (TextView) view.findViewById(com.example.library.R.id.bottom_navigation_item_title);
                final ImageView icon = (ImageView) view.findViewById(com.example.library.R.id.bottom_navigation_item_icon);
                ...
                View view = viewList.get(i).findViewById(com.example.library.R.id.bottom_navigation_container);
                final TextView title = (TextView) view.findViewById(com.example.library.R.id.bottom_navigation_item_title);
                final ImageView icon = (ImageView) view.findViewById(com.example.library.R.id.bottom_navigation_item_icon);
