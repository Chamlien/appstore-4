package com.example.library.FlashTextView;
...
public class Flash {
    ...
    public void start(final FlashTextView textView) {
        ...
        if (!textView.isSetUp()) {
            textView.setAnimationSetupCallback(new FlashTextView.AnimationSetupCallback() {
                @Override
                public void onSetupAnimation(final FlashTextView target) {
                    animate.run();
                }
            });
        } else {
